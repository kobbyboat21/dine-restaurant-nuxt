...
export { useBookingStore } from '../stores/bookings';
export { useBreakfastStore } from '../stores/breakfast_menu';
export { useDinnerStore } from '../stores/dinner_menu';
export { useLunchStore } from '../stores/lunch_menu';
