...
export declare const DEFAULT_OPTIONS: ViewportOptions;
...
export declare function createViewportManager(options: ViewportOptions, state: Ref<string>): {
    breakpoint: import("vue-demi").WritableComputedRef<string>;
    ...
    queries: import("vue-demi").ComputedRef<Record<string, ViewportQuery>>;
};
